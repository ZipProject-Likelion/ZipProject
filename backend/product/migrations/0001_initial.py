    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('online_shop', models.CharField(choices=[('오늘의 집', '오늘의 집'), ('해외사이트', '해외사이트'), ('네이버 스마트스토어', '네이버 스마트스토어'), ('기타', '기타'), ('집꾸미기', '집꾸미기'), ('이케아', '이케아')], default='오늘의 집', max_length=100)),
                ('image', models.ImageField(blank=True, upload_to='images/')),
                ('price', models.IntegerField(default=0)),
                ('shop_Type', models.CharField(choices=[('오프라인', '오프라인'), ('온라인', '온라인'), ('비매품', '비매품')], default='온라인', max_length=20)),
                ('shop_URL_Location', models.CharField(default='', max_length=500)),
                ('type', models.CharField(choices=[('가전', '가전'), ('가구', '가구'), ('DIY/공구', 'DIY/공구'), ('장식/조명', '장식/조명'), ('패브릭', '패브릭'), ('수납/정리', '수납/정리')], default='가구', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='ProductTag',
